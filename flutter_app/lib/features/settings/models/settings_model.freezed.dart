...
mixin _$SettingsModel {
 ...
 ThemeMode get themeMode; bool get notificationsEnabled; String get languageCode;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,themeMode,notificationsEnabled,languageCode);

@override
String toString() {
  return 'SettingsModel(themeMode: $themeMode, notificationsEnabled: $notificationsEnabled, languageCode: $languageCode)';
}
...
@useResult
$Res call({
 ThemeMode themeMode, bool notificationsEnabled, String languageCode
});
...
/// Create a copy of SettingsModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? themeMode = null,Object? notificationsEnabled = null,Object? languageCode = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ThemeMode themeMode,  bool notificationsEnabled,  String languageCode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettingsModel() when $default != null:
return $default(_that.themeMode,_that.notificationsEnabled,_that.languageCode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ThemeMode themeMode,  bool notificationsEnabled,  String languageCode)  $default,) {final _that = this;
switch (_that) {
case _SettingsModel():
return $default(_that.themeMode,_that.notificationsEnabled,_that.languageCode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ThemeMode themeMode,  bool notificationsEnabled,  String languageCode)?  $default,) {final _that = this;
switch (_that) {
case _SettingsModel() when $default != null:
return $default(_that.themeMode,_that.notificationsEnabled,_that.languageCode);case _:
  return null;
...
class _SettingsModel implements SettingsModel {
  const _SettingsModel({this.themeMode = ThemeMode.system, this.notificationsEnabled = true, this.languageCode = 'en'});
...
/// Create a copy of SettingsModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? themeMode = null,Object? notificationsEnabled = null,Object? languageCode = null,}) {
