...
mixin _$UpdateProfileRequest {
 ...
 String? get name; String? get email; String? get role; String? get avatar; String? get department;@JsonKey(name: 'manager_id') String? get managerId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,email,role,avatar,department,managerId);

@override
String toString() {
  return 'UpdateProfileRequest(name: $name, email: $email, role: $role, avatar: $avatar, department: $department, managerId: $managerId)';
}
...
@useResult
$Res call({
 String? name, String? email, String? role, String? avatar, String? department,@JsonKey(name: 'manager_id') String? managerId
});
...
/// Create a copy of UpdateProfileRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = freezed,Object? email = freezed,Object? role = freezed,Object? avatar = freezed,Object? department = freezed,Object? managerId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? name,  String? email,  String? role,  String? avatar,  String? department, @JsonKey(name: 'manager_id')  String? managerId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateProfileRequest() when $default != null:
return $default(_that.name,_that.email,_that.role,_that.avatar,_that.department,_that.managerId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? name,  String? email,  String? role,  String? avatar,  String? department, @JsonKey(name: 'manager_id')  String? managerId)  $default,) {final _that = this;
switch (_that) {
case _UpdateProfileRequest():
return $default(_that.name,_that.email,_that.role,_that.avatar,_that.department,_that.managerId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? name,  String? email,  String? role,  String? avatar,  String? department, @JsonKey(name: 'manager_id')  String? managerId)?  $default,) {final _that = this;
switch (_that) {
case _UpdateProfileRequest() when $default != null:
return $default(_that.name,_that.email,_that.role,_that.avatar,_that.department,_that.managerId);case _:
  return null;
...
class _UpdateProfileRequest implements UpdateProfileRequest {
  const _UpdateProfileRequest({this.name, this.email, this.role, this.avatar, this.department, @JsonKey(name: 'manager_id') this.managerId});
...
/// Create a copy of UpdateProfileRequest
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = freezed,Object? email = freezed,Object? role = freezed,Object? avatar = freezed,Object? department = freezed,Object? managerId = freezed,}) {
