...
export default function SettingsPage() {
  ...
  const { isAuthenticated, currentUser, languageCode, setLanguageCode } = useStore()
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select value={languageCode || 'en'} onValueChange={setLanguageCode}>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Automatically save ticket drafts as you type
                      </p>
                    </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Share your recent activity with team
                      </p>
                    </div>
                    <Switch defaultChecked />
                  </div>
