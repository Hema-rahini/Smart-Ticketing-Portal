...
export function KanbanBoard() {
  const { tickets, users, currentUser, updateTicket } = useStore()
  ...
  const handleDragEnd = (result: DropResult) => {
    ...
    // 1. Closed tickets cannot be updated or reopened
    if (targetTicket.status === 'closed') {
      alert('This ticket is closed and cannot be updated or reopened.')
      return
    }

    // 2. Only assigned user or manager/admin can edit/update ticket
